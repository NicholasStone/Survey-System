                    ...
                    @if($submissions->count())
                        <div class="table-responsive">
                            <table class="table table-bordered d-table table-striped pb-0 mb-0">
                                ...
                                <tr>
                                    <th class="five">#</th>
                                    <th class="fifteen">{{ __('formbuilder.common.user-name') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('formbuilder::forms.submissions.show', [$form, $submission->id]) }}"
                                               class="btn btn-primary btn-sm" title="{{__('formbuilder.form.submissions.view-submission')}}">
                                                <i class="fa fa-eye"></i> {{ __('formbuilder.form.submissions.view') }}
                                            </a>
                                            ...
                                            <form action="{{ route('formbuilder::forms.submissions.destroy', [$form, $submission]) }}"
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm confirm-form"
                                                        ...
                                                        data-message="{{ __('formbuilder.form.submissions.delete-submission-message') }}?"
                                                        title="{{ __('formbuilder.form.submissions.delete-submission') }}">
